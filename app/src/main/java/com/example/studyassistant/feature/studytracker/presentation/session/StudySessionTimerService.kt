...
import com.example.studyassistant.feature.studytracker.presentation.util.Constants.NOTIFICATION_CHANNEL_NAME
import com.example.studyassistant.feature.studytracker.presentation.util.Constants.NOTIFICATION_ID
import com.example.studyassistant.feature.studytracker.presentation.util.pad
...
class StudySessionTimerService: Service() {
    ...
    var currentTimerState = mutableStateOf(TimerState.IDLE)
        private set
    var subjectId = mutableStateOf<String?>(null)
